const config = {
  ...
  announcementChannelID: "1332068871175405568",
  bugReportChannelID: "1332068885033390220",
  defaultPrefix: "!",
    ...
    fields: [
      ...
      },
      {
        ...
        value: [
          ...
          "` 🖼️ removebg <image url>` - Remove background from image using removebg",
        ].join("\n"),
        inline: false,
      },
    ],
    ...
    fields: [
      ...
      },
      {
        ...
        value: [
          ...
          "`🔧 setupguild` - Setup guild channel",
        ].join("\n"),
        inline: false,
      },
    ],
