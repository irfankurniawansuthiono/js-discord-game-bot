    ...
    constructor(client) {
        ...
        this.commandBuilders = {
            ...
            resetRepo: () => ({
                ...
                execute: async (interaction) => {
                    try {
                        if(interaction.user.id !== config.ownerId[0]) return interaction.reply({ content: `${discordEmotes.error} You are not authorized to use this command.`, ephemeral: true });
